...
'main-menu': {
  ...
  'date-selector': {
    portrait: (props) => <DateSelectorVertical onHome={() => props.navigate('main-menu')} onSkip={() => props.navigateNext('name-entry')} onNext={() => props.navigateNext('birthdate-card-stack')} onSubmit={props.onBirthDateSubmit} onBack={() => props.navigateBack('card-finder-introduction-part-2')} showNext={props.workflowConfig.currentIteration < props.workflowConfig.lastIteration} />,
    landscape: (props) => <DateSelectorHorizontal onHome={() => props.navigate('main-menu')} onSkip={() => props.navigateNext('name-entry')} onNext={() => props.navigateNext('birthdate-card-stack')} onSubmit={props.onBirthDateSubmit} onBack={() => props.navigateBack('card-finder-introduction-part-2')} showNext={props.workflowConfig.currentIteration < props.workflowConfig.lastIteration} />,
  },
  'name-entry': {
    portrait: (props) => <NameEntryVertical onHome={() => props.navigate('main-menu')} onSkip={() => props.navigateNext('nativety-time-entry')} onNext={() => props.navigateNext('name-card-stack')} onSubmit={props.onNameSubmit} onBack={() => props.navigateBack('birthdate-card-stack')} showNext={props.workflowConfig.currentIteration < props.workflowConfig.lastIteration} />,
    landscape: (props) => <NameEntryHorizontal onHome={() => props.navigate('main-menu')} onSkip={() => props.navigateNext('nativety-time-entry')} onNext={() => props.navigateNext('name-card-stack')} onSubmit={props.onNameSubmit} onBack={() => props.navigateBack('birthdate-card-stack')} showNext={props.workflowConfig.currentIteration < props.workflowConfig.lastIteration} />,
  },
  'nativety-time-entry': {
    portrait: (props) => <NativetyTimeEntryVertical onHome={() => props.navigate('main-menu')} onSkip={() => props.navigateNext('birth-location-entry')} onNext={() => props.navigateNext('birth-location-entry')} onBack={() => props.navigateBack('name-card-stack')} showNext={props.workflowConfig.currentIteration < props.workflowConfig.lastIteration} />,
    landscape: (props) => <NativetyTimeEntryHorizontal onHome={() => props.navigate('main-menu')} onSkip={() => props.navigateNext('birth-location-entry')} onNext={() => props.navigateNext('birth-location-entry')} onBack={() => props.navigateBack('name-card-stack')} showNext={props.workflowConfig.currentIteration < props.workflowConfig.lastIteration} />,
  },
  'birth-location-entry': {
    portrait: (props) => <BirthLocationEntryVertical onHome={() => props.navigate('main-menu')} onSkip={() => props.navigateNext('growth-card-stack')} onNext={() => props.navigateNext('growth-card-stack')} onBack={() => props.navigateBack('nativety-time-entry')} showNext={props.workflowConfig.currentIteration < props.workflowConfig.lastIteration} />,
    landscape: (props) => <BirthLocationEntryHorizontal onHome={() => props.navigate('main-menu')} onSkip={() => props.navigateNext('growth-card-stack')} onNext={() => props.navigateNext('growth-card-stack')} onBack={() => props.navigateBack('nativety-time-entry')} showNext={props.workflowConfig.currentIteration < props.workflowConfig.lastIteration} />,
  },
  'card-stack': {
  ...
  'birthdate-card-stack': {
    portrait: (props) => <CardStackVertical cards={props.birthdateCards} onHome={() => props.navigate('main-menu')} onNext={() => props.navigateNext('practitioner-view')} onBack={() => props.navigateBack('date-selector')} />,
    landscape: (props) => <CardStackHorizontal cards={props.birthdateCards} onHome={() => props.navigate('main-menu')} onNext={() => props.navigateNext('practitioner-view')} onBack={() => props.navigateBack('date-selector')} />,
  },
  'name-card-stack': {
    portrait: (props) => <CardStackVertical cards={props.nameCards} onHome={() => props.navigate('main-menu')} onNext={() => props.navigateNext('practitioner-view')} onBack={() => props.navigateBack('name-entry')} />,
    landscape: (props) => <CardStackHorizontal cards={props.nameCards} onHome={() => props.navigate('main-menu')} onNext={() => props.navigateNext('practitioner-view')} onBack={() => props.navigateBack('name-entry')} />,
  },
  'growth-card-stack': {
    portrait: (props) => <CardStackVertical cards={props.growthCards} onHome={() => props.navigate('main-menu')} onNext={() => props.navigateNext('practitioner-view')} onBack={() => props.navigateBack('nativety-time-entry')} />,
    landscape: (props) => <CardStackHorizontal cards={props.growthCards} onHome={() => props.navigate('main-menu')} onNext={() => props.navigateNext('practitioner-view')} onBack={() => props.navigateBack('nativety-time-entry')} />,
  },
  'practitioner-view': {
    portrait: (props) => <PractitionerViewVertical birthdateCards={props.birthdateCards} nameCards={props.nameCards} growthCards={props.growthCards} onHome={() => props.navigate('main-menu')} navigate={(page) => props.navigate(page)} />,
    landscape: (props) => <PractitionerViewHorizontal birthdateCards={props.birthdateCards} nameCards={props.nameCards} growthCards={props.growthCards} onHome={() => props.navigate('main-menu')} navigate={(page) => props.navigate(page)} />,
  }
};
