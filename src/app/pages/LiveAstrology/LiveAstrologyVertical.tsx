...
import './LiveAstrologyVertical.css';
...
export default function LiveAstrologyVertical({ onHome }: { onHome: () => void }) {
    ...
    return (
        <div className="live-astrology-vertical live-astrology-root">
